...
public class Entity extends GameObject {
	...
	public Image getSprite() {
		...
		BufferedImage image = new BufferedImage((int) (dmtr * this.size), (int) (dmtr * this.size), BufferedImage.TYPE_INT_ARGB); //ARGB for transparency
